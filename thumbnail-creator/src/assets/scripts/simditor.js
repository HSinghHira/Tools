...
Toolbar = (function(superClass) {
  ...
  Toolbar.prototype._tpl = {
    wrapper: '<div class="simditor-toolbar px-1 py-2"><ul><li class="text-gray-800 dark:text-white"><a tabindex="-1" class="toolbar-item dark:text-white" style="width:100%;font-size:15px"><span class="dark:text-white" lang="Post Title"></span></a></li><li class="dark:text-white"><span class="separator dark:text-white" style=" color: black; "></span></li></ul></div>',
    separator: '<li><span class="separator dark:text-white"></span></li>'
  };
...
Simditor = (function(superClass) {
  ...
  Simditor.prototype._tpl = "<div class=\"simditor simditor py-1 px-2 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600\">\n  <div class=\"simditor-wrapper\">\n    <div class=\"simditor-placeholder\"></div>\n    <div class=\"simditor-body\" contenteditable=\"true\">\n    </div>\n  </div>\n</div>";
...
Button = (function(superClass) {
  ...
  Button.prototype._tpl = {
    item: '<li class="dark:text-white"><a tabindex="-1" unselectable="off" class="toolbar-item" href="javascript:;"><span></span></a></li>',
    menuWrapper: '<div class="toolbar-menu"></div>',
    menuItem: '<li class="dark:text-white"><a tabindex="-1" unselectable="off" class="menu-item" href="javascript:;"><span></span></a></li>',
    separator: '<li class="dark:text-white"><span class="separator"></span></li>',
  ...
  FontScaleButton.prototype.command = function(param) {
    ...
    $scales.each((function(_this) {
      return function(i, n) {
        ...
        if (/large|x-large|small|x-small|xx-small/.test(size)) {
